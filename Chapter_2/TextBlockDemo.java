/* This program demonstrates text blocks.  A text block
...
public class TextBlockDemo {
   ...
   public static void main(String[] args) {
       ...
       /* A text block can include escaped characters such as \t, \n,
        ...
        * such as in a formatted print statement (See Section 2.4.1). */
